...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="http://feibu.info/test/weChatPay/example/jsapi.php">JSAPI支付</a></li>
            ...
            <li style="background-color:#CD3278"><a href="http://feibu.info/test/weChatPay/example/refund.php">订单退款</a></li>
            <li style="background-color:#848484"><a href="http://feibu.info/test/weChatPay/example/refundquery.php">退款查询</a></li>
